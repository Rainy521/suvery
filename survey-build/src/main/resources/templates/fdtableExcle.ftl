...
<Workbook
    ...
    <DocumentProperties
        ...
        <LastAuthor>雨de蜻挡不住</LastAuthor>
        <Created>2020-06-21T23:06:00Z</Created>
        <LastSaved>2020-09-15T01:22:42Z</LastSaved>
    </DocumentProperties>
    <CustomDocumentProperties
        xmlns="urn:schemas-microsoft-com:office:office">
        <KSOProductBuildVer dt:dt="string">2052-11.1.0.9926</KSOProductBuildVer>
    </CustomDocumentProperties>
    <ExcelWorkbook
    ...
    <Styles>
        ...
        <Style ss:ID="s50">
            ...
            <Font ss:FontName="宋体" x:CharSet="134" ss:Size="10" ss:Color="#000000" ss:Bold="1"/>
        </Style>
        <Style ss:ID="s51">
            <Alignment ss:Horizontal="Center" ss:Vertical="Center" ss:WrapText="1"/>
        ...
        <Style ss:ID="s52">
            ...
            <Font ss:FontName="仿宋" x:CharSet="134" ss:Size="12" ss:Color="#000000"/>
        </Style>
        <Style ss:ID="s53">
            <Alignment ss:Horizontal="Center" ss:Vertical="Center" ss:WrapText="1"/>
            <Borders>
        ...
        <Style ss:ID="s60">
            ...
            <Font ss:FontName="仿宋" x:CharSet="134" ss:Size="12"/>
        </Style>
        <Style ss:ID="s61">
            <Alignment ss:Horizontal="Center" ss:Vertical="Center"/>
            <Borders>
    ...
    <Worksheet ss:Name="Sheet1">
        <Names>
            <NamedRange ss:Name="Print_Titles" ss:RefersTo="=Sheet1!R1"/>
        </Names>
        <Table ss:ExpandedColumnCount="999" ss:ExpandedRowCount="999" x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="48.6" ss:DefaultRowHeight="14.4">
            <Column ss:Index="1" ss:StyleID="Default" ss:AutoFitWidth="0" ss:Width="44.55"/>
            <Column ss:Index="2" ss:StyleID="Default" ss:AutoFitWidth="0" ss:Width="213.3"/>
            <Column ss:StyleID="s50" ss:AutoFitWidth="0" ss:Width="62.8"/>
            <Column ss:StyleID="Default" ss:AutoFitWidth="0" ss:Width="62.8" ss:Span="5"/>
            <Row ss:Height="35">
                <Cell ss:StyleID="s75" ss:MergeAcross="10">
                    <Data ss:Type="String">“多测合一”测绘成果审核备案情况统计表</Data>
                </Cell>
            </Row>
            <Row ss:Height="20">
                <Cell ss:StyleID="s83" ss:MergeAcross="10">
                    <Data ss:Type="String">(${beginGdrq?if_exists}至${endGdrq?if_exists})</Data>
                </Cell>
            </Row>
            <Row ss:Height="21">
                ...
                <Cell ss:StyleID="s81" ss:MergeDown="1">
                    <Data ss:Type="String">测绘单位</Data>
                </Cell>
                <Cell ss:StyleID="s76" ss:MergeAcross="3">
                    <Data ss:Type="String">房产测绘</Data>
                </Cell>
                <Cell ss:StyleID="s77" ss:MergeAcross="1">
                    <Data ss:Type="String">地籍测绘</Data>
                </Cell>
                <Cell ss:StyleID="s78" ss:MergeAcross="1">
                    <Data ss:Type="String">工程测量</Data>
                </Cell>
                <Cell ss:StyleID="s82" ss:MergeDown="1">
                    <Data ss:Type="String">退回率</Data>
                </Cell>
            </Row>
            <Row ss:Height="21">
                <Cell ss:Index="3" ss:StyleID="s58">
                    <Data ss:Type="String">预测幢数</Data>
                </Cell>
                <Cell ss:StyleID="s59">
                    <Data ss:Type="String">预测面积</Data>
                </Cell>
                <Cell ss:StyleID="s58">
                    <Data ss:Type="String">实测幢数</Data>
                </Cell>
                <Cell ss:StyleID="s59">
                    <Data ss:Type="String">实测面积</Data>
                </Cell>
                <Cell ss:StyleID="s58">
                    <Data ss:Type="String">宗地数</Data>
                </Cell>
                <Cell ss:StyleID="s60">
                    <Data ss:Type="String">占地面积</Data>
                </Cell>
                <Cell ss:StyleID="s61">
                    <Data ss:Type="String">幢楼</Data>
                </Cell>
                <Cell ss:StyleID="s61">
                    <Data ss:Type="String">建筑面积</Data>
                </Cell>
            </Row>
            <#assign x = 1> <#-- 创建变量 x -->
            <#list list as listMember>
            	<#if (listMember.chdw == '合计')>
	             	<Row ss:Height="21">
		                <Cell ss:StyleID="s57">
		                    <Data ss:Type="Number">${x}</Data>
		                </Cell>
		                <Cell ss:StyleID="s65">
		            ...
		            <Row ss:Height="21">
		                ...
		                <Cell ss:StyleID="s71">
		                    <Data ss:Type="String">${listMember.fcyczs}</Data>
		                </Cell>
		                <Cell ss:StyleID="s72">
		                	<Data ss:Type="String">${listMember.fcyczmj}</Data>
		                </Cell>
		                <Cell ss:StyleID="s71">
		                    <Data ss:Type="String">${listMember.fcsczs}</Data>
		                </Cell>
		                <Cell ss:StyleID="s72">
		                	<Data ss:Type="String">${listMember.fcsczmj}</Data>
		                </Cell>
		                <Cell ss:StyleID="s72">
		                	<Data ss:Type="String">${listMember.djzds}</Data>
		                </Cell>
		                <Cell ss:StyleID="s72">
		                	<Data ss:Type="String">${listMember.djmj}</Data>
		                </Cell>
		                <Cell ss:StyleID="s72">
		                	<Data ss:Type="String">${listMember.ggzs}</Data>
		                </Cell>
		                <Cell ss:StyleID="s72">
		                	<Data ss:Type="String">${listMember.ggmj}</Data>
		                </Cell>
		                <Cell ss:StyleID="s72">
		                	<Data ss:Type="String">${listMember.backNum}</Data>
		                </Cell>
		            </Row>
            	<#else>
            		<Row ss:Height="21">
		                ...
		                <Cell ss:StyleID="s58">
		                    <Data ss:Type="String">${listMember.chdw}</Data>
		                </Cell>
		                <Cell ss:StyleID="s62">
		                	<Data ss:Type="String">${listMember.fcyczs}</Data>
		                </Cell>
        ...
        <WorksheetOptions
            ...
            <PageSetup>
                ...
                <Header/>
                <Footer/>
                <PageMargins x:Left="0.751388888888889" x:Right="0.751388888888889" x:Top="0.60625" x:Bottom="0.60625"/>
            </PageSetup>
            <Selected/>
            ...
            <Panes>
                <Pane>
                    ...
                    <RangeSelection>R11C8</RangeSelection>
                </Pane>
            </Panes>
