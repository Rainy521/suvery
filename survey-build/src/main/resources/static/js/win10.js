...
window.Win10 = {
    ...
    exit:function () {
        layer.confirm(Win10.lang('确认要注销登录吗?','Are you sure you want to close this page?'), {icon: 3, title:Win10.lang('提示','Prompt')}, function(index){
            document.body.onbeforeunload = function(){};
            window.location.href="/logout";
            window.close();
            layer.close(index);
            layer.alert(Win10.lang('等候中。','Ops...There seems to be a little problem.'), {
