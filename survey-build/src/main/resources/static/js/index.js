layui.config({
    ...
    $(function () {
        ...
        if(isIE!=-1){
            ...
            winui.window.msg('欢迎来到肥东县房产测绘面积管理中心', {
                time: 3500,
                btn: ['点击进入全屏','取消'],
                btnAlign: 'c',
                yes: function (index) {
        ...
        /*winui.window.open({
            ...
            anim: 2,
            isOutAnim:true,
            content: '<p style="padding:20px;">欢迎admin！</p>',
            area: ['250px', '200px']
        });*/
    ...
    //开始菜单左侧主题按钮点击
    $('.winui-start-item.person').on('click', function () {
        OpenWindow(this)
    });
