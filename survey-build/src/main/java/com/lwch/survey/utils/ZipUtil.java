...
public class ZipUtil {
	 ...
	 * @throws Exception
	 */
	public static void unzip(File zip, String out) throws IOException    {
	...
	public static void main(String[] args) throws Exception {
		...
		String originDir = "D:\\SysTestProject\\112.zip";
		String path = "D:\\SysTestProject\\JavaPro\\Test\\" + uuid ;
		unzip(originDir, path);
	}
}
