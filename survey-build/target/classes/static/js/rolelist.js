layui.config({
    ...
    table.render({
        ...
        cols: [[
            ...
            { field: 'roleName', title: '名称', width: 4*colWidth },
            { field: 'description', title: '描述', width: 10*colWidth},
            { field: 'dataState', title: '状态', width: 2*colWidth, templet: '#stateTpl' },
            { title: '操作', fixed: 'right', align: 'center', toolbar: '#barRole', width: 3*colWidth }
        ]]
    });
    //监听工具条
